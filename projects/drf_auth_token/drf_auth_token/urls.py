"""
URL configuration for drf_auth_token project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Documentation API DRF-Auth-Token.",
        default_version='v0.1',
        description="Documentation API DRF-Auth-Token",
